...
public class SchedulingService {
        ...
        public WeekResponse createWeek(WeekRequest request) {
                Week week = Week.builder()
                                .name("Week " + request.getWeekNumber())
        ...
        public SlotResponse createSlot(Long weekId, SlotRequest request) {
                ...
                // Determine times based on slot number
                String startTime, endTime;
                switch (request.getSlotNumber()) {
                        case 1:
                                startTime = "08:00";
                                endTime = "11:00";
                                break;
        ...
        @Transactional
        public SlotResponse updateNotes(Long slotId, String notes) {
                Slot slot = slotRepository.findById(slotId)
                                .orElseThrow(() -> new RuntimeException("Slot not found"));
                slot.setNotes(notes);
                slotRepository.save(slot);
