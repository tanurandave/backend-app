...
import com.training.backend_app.security.CustomUserDetails;
import com.training.backend_app.security.JwtUtil;
...
public class AuthService {
        ...
        public PasswordResetResponse resetPassword(PasswordResetRequest request) {
                ...
                // Gate behind OTP verification
                if (!otpService.isOtpVerified(email)) {
                        throw new RuntimeException("OTP not verified. Please complete OTP verification first.");
                }
